...
public class RateLimiterConfig {
    ...
    public StatefulRedisConnection<String, byte[]> bucket4jConnection(LettuceConnectionFactory redisConnectionFactory) {
    ...
    @Bean
    public ProxyManager<String> proxyManager(StatefulRedisConnection<String, byte[]> bucket4jConnection){
